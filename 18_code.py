"""
Run 16, but compare to leaky relu!
"""
import os
import sys
...
from reusable.vae import LeakyVAE, vae_sample
...
print(f"Starting 18, experiment {experiment}, index={index}", flush=True)
setup_signals()
...
if not pre_trained:
    if not pre_generated_data:
        ...
        save_datasets(
            args["data_expcode"],
            gen_file_name(args["data_expcode"], args, "raw_gp", data_only=True),
            train_draws,
            test_draws,
        )
